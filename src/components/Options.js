...
const Options = () => {
    const [options, setOptions] = useState([
        ...
        { id: 2, name: 'Roles' },
        { id: 3, name: 'Opciones' },
        { id: 4, name: 'Información Básica Trabajador' },
    ...
    const handleSaveOption = (option) => {
        if (currentOption) {
            ...
            setOptions([...options, { ...option, id: options.length + 1 }]);
        }
        setIsFormOpen(false);
    };
            ...
            {confirmDelete && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded shadow-lg">
                        ...
                        <p>¿Estás seguro de que quieres eliminar la opción {optionToDelete.name}?</p>
