...
const TrabajoRemoto = () => {
    const [data, setData] = useState([{
            ...
            remoteWork: 'Sí',
            computerType: 'Laptop',
            internetConnection: 'Buena',
            homeEnvironment: 'Adecuado'
        },
        {
            id: 2,
            remoteWork: 'No',
            computerType: 'PC de Escritorio',
            internetConnection: 'Regular',
            homeEnvironment: 'No Adecuado'
        },
    ]);
...
const Form = ({
    ...
    return ( <
        ...
        h2 className = "text-xl font-bold mb-4" > {
            form.id ? 'Editar Trabajo Remoto' : 'Añadir Trabajo Remoto'
        } < /h2> <
        div className = "mb-4" >
        <
